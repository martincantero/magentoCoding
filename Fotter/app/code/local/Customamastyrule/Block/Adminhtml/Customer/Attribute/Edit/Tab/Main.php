...
/**
 *
 * Fotter_Customamastyrule_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main
 *
 * @category   Fotter
 * @package    Fotter_Customamastyrule
 * @copyright  www.fotter.com.ar
 * @author     Fotter Core Team <martin.cantero@fotter.com.ar>
 * @info:      http://redmine.fotter.net/issues/7715
 */
class Fotter_Customamastyrule_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main extends Amasty_Customerattr_Block_Adminhtml_Customer_Attribute_Edit_Tab_Main
{
    protected function _prepareForm()
    {
        ...
        Mage::log(' Fotter_Customamastyrule_Block_Adminhtml');
        ...
        $ordinaryValidationRules = array(
            ...
            array(
                'value' => 'validate-eightdigits',
                'label' => Mage::helper('amcustomerattr')->__('8 Digits Integer Number')
            ),
            array(
