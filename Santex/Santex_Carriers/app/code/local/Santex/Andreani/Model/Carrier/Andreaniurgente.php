...
class Santex_Andreani_Model_Carrier_Andreaniurgente extends Santex_Andreani_Model_Carrier_Andreani
{
    ...
    protected function _getAndreaniUrgente($datos,$request){
        ...
        $helper->_getLogger()->saveLog("Andreani Urgente", $this->_process_name);
